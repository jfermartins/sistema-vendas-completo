...
var ListProductService_1 = __importDefault(require("../services/ListProductService"));
var ShowProductService_1 = __importDefault(require("../services/ShowProductService"));
...
var ProductsController = /** @class */ (function () {
    ...
    ProductsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listProducts = new ListProductService_1.default();
    ...
    ProductsController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, showProduct, product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = request.params.id;
                        showProduct = new ShowProductService_1.default();
                        return [4 /*yield*/, showProduct.execute({ id: id })];
                    case 1:
                        product = _a.sent();
    ...
    ProductsController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, price, quantity, id, updateProduct, product;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, price = _a.price, quantity = _a.quantity;
                        id = request.params.id;
                        updateProduct = new UpdateProductService_1.default();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = request.params.id;
                        deleteProduct = new DeleteProductService_1.default();
                        return [4 /*yield*/, deleteProduct.execute({ id: id })];
                    case 1:
                        _a.sent();
